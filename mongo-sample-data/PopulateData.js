...
const username = "DuongTran";
const password = "DuongTran";

// MongoDB connection URL to the desired database
const connectionStringURL = `mongodb+srv://${username}:${password}@webprogonlinelearningpl.nvobszj.mongodb.net/?retryWrites=true&w=majority`;
